...
class TicTacToe:
    def __init__(self, master, user_symbol):
        ...
        self.bg_image = Image.open(r"C:\Users\brr_c\OneDrive\Masaüstü\HasanGündüz_BerraÇelik_EngineeringProject_SecondJury\tahta_5.jpeg")
        ...
        self.level_label = tk.Label(self.master, text="Level 4", font=("Helvetica",30, "bold"),bg='gray', fg='black')
    ...
    def make_move(self, row, col):
        if self.board[row][col] == "":
            ...
            if winner:
                if winner == "X":
                    messagebox.showinfo("Level Completed", "Level 3 completed!")
                    self.master.destroy()
                    subprocess.run(["python", "level_3.py"])
                else:
