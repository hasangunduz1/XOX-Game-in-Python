...
class TicTacToe:
    def __init__(self, master, user_symbol):
        ...
        self.bg_image = Image.open(r"C:\Users\brr_c\OneDrive\Masaüstü\HasanGündüz_BerraÇelik_EngineeringProject_SecondJury\tahta_4.png")
        ...
        self.level_label = tk.Label(self.master, text="Level 3", font=("Helvetica",30, "bold"),bg='gray', fg='black')
        ...
        if self.board[row][col] == "":
            ...
            if winner:
                if winner == "X":
                    ...
                    self.master.destroy()
                    subprocess.run(["python", "level_4.py"])
                else:
