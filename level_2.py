...
class TicTacToe:
    def __init__(self, master, user_symbol):
        ...
        self.level_label = tk.Label(self.master, text="Level 2", font=("Helvetica",30, "bold"),bg='gray', fg='black')
    ...
    def select_reverse_button(self):
        self.master.destroy()
        subprocess.run(["python", "level_main2.py"])
    ...
    def make_move(self, row, col):
        if self.board[row][col] == "":
            ...
            if winner:
                if winner == "X":
                    messagebox.showinfo("Level Completed", "Level 2 completed!")
                    self.master.destroy()
