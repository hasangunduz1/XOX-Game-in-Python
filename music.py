...
class Music(tk.Tk):
    ...
    def create_widgets(self):
        ...
        reverse_button = tk.Button(self, text="←", command=self.select_reverse_button, font=('Arial', 14, 'bold'), bg='#EF802F', fg='white', height=1, width=3)
