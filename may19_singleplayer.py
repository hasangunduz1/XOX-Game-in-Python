...
class SinglePlayer:
    def __init__(self, root,language=None):
        ...
        player1_label = tk.Label(self.app, text=player1_text, font=('Helvetica', 18, 'bold'), bg=bg_color, fg=black_color)
        ...
        select_character_label= tk.Label(self.app, text=select_character_text, font=('Helvetica', 15, 'bold'), bg=bg_color, fg=black_color)
    ...
    def select_settings_button(self):
        ...
        subprocess.run(["python", "may19_settings_single.py"])
    ...
    def select_play(self):
        if self.starting_symbol is None:
            ...
            if self.total_rounds == 1:
                tur_files = "may19_stur_1.py"
            elif self.total_rounds == 3:
                tur_files = "may19_stur_3.py"
            elif self.total_rounds == 5:
                tur_files = "may19_stur_5.py"
            elif self.total_rounds == 11:
                tur_files = "may19_stur_11.py"
            else:
